                ...
                <nav id="main-menu-navigation" class="navigation-main">
                    ...
                    <div class="nav-item has-sub">
                        <a href="javascript:void(0)">
                            <i class="ik ik-layers"></i><span>Specialist</span> <span class="badge badge-danger"></span></a>
                    ...
                    @if(auth()->check()&& auth()->user()->role->name === 'admin')
                    <div class="nav-item has-sub">
                        <a href="javascript:void(0)"><i class="ik ik-user-plus"></i><span>Doctor</span> <span class="badge badge-danger"></span></a>
                        <div class="submenu-content">
                    ...
                    <div class="nav-item has-sub">
                        <a href="javascript:void(0)"><i class="ik ik-calendar"></i><span>Appointment Time</span> <span class="badge badge-danger"></span></a>
                        <div class="submenu-content">
                    ...
                    @if(auth()->check()&& auth()->user()->role->name === 'admin')
                    <div class="nav-item has-sub">
                        <a href="javascript:void(0)"><i class="ik ik-users"></i><span>Patient Appointment</span> <span class="badge badge-danger"></span></a>
                        <div class="submenu-content">
